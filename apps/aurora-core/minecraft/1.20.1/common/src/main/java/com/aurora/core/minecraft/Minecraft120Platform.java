...
final class Minecraft120Platform implements AuroraCorePlatform {
    ...
    @Override public String minecraftVersion() {
        return System.getProperty("aurora.minecraft.version", "1.20.1");
    }
    ...
    @Override public void log(AuroraLog.Level level, String message, Throwable error) {
        if (level == AuroraLog.Level.ERROR || level == AuroraLog.Level.WARN) System.err.println(message);
